...
import (
	...
	"github.com/azaurus1/headscale-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(headscalev1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "0f0206ec.azaurus.dev",
	...
	if err = (&controller.HeadscaleReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Headscale")
		os.Exit(1)
	}
